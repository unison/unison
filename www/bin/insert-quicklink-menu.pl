	 ...
	 <table class="quicklinks">
	  ...
	  <tr>
	   ...
	   <td>
		...
		| <a class="extlink" target="_blank" href="http://unison-db.svn.sourceforge.net/viewvc/unison-db/trunk/">browse svn trunk</a>
       </td>
	  </tr>
	  ...
	  <tr>
	   <th>contact</th>
	   <td>
		  <a class="extlink" target="_blank" href="http://sourceforge.net/tracker/?atid=759616&amp;group_id=140591&amp;func=browse">issues</a>
		| <a class="extlink" target="_blank" href="http://lists.sourceforge.net/lists/listinfo/unison-db-announce">mailing list</a>
  	   </td>
	  </tr>
