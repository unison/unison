#!/usr/bin/env perl
#$ID = q$Id: pseq_structure.pl,v 1.12 2005/08/19 00:08:29 rkh Exp $;
...
$p->add_footer_lines('$Id: pseq_structure.pl,v 1.12 2005/08/19 00:08:29 rkh Exp $ ');
...
try {
    ...
    print $p->render("Unison:$v->{pseq_id} Structural Features",
		     ...
		     $p->group("Templates found for Unison:$v->{pseq_id}",  Unison::WWW::Table::render(\@templates_cols,$templates_ar,{scroll => 1})),
		     '<p>',
