...
include only sequences and results available from non-proprietary sources.
Source sequences and data may be copyrighted by the original authors.
Links to the licenses for the freely available and redistributable sources
are available on the <a href="about_credits.pl">Unison credits page</a>.


<hr>
<h3>The Academic Free License v. 2.1</h3>
The AFL is an <a
href="http://www.opensource.org/docs/definition.php"><img 
src="http://www.opensource.org/trademarks/open_source_button.png"
border="0" width="88" height="31" alt="OpenSource"></a>
approved license.
