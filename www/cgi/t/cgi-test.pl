...
# $Id: cgi-test.pl,v 1.6 2005/07/27 18:37:06 rkh Exp $
...
print('$Id: cgi-test.pl,v 1.6 2005/07/27 18:37:06 rkh Exp $ ', "\n\n");
...
foreach my $cgi (@cgi_scripts) {
  ...
  if ($?) {
	...
	# this concept doesn't work because we output more than just html
