...
sub _read_swissprot_Species {
    ...
    my $osline = "";
    my $do_genus_check = 1; #from veriosn 1.105
    while ( defined $_ ) {
        last unless /^O[SCGX]/;
...
#    return if grep { /^\Q$sci_name$/ } @Unknown_names;
    ...
    # spaces
    # Kiran Mukhyala, example in CH10_ACEAC
    # problem line: OC   Acetobacteraceae; Acetobacter; Acetobacter subgen. Acetobacter.
    $class_lines=~s/\.\s*$//;
    ...
    elsif ($do_genus_check) { #From verion 1.105
        # do we have a genus?
