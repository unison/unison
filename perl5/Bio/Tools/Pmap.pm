# Bio::Tools::Pmap
#
# Trivially adapted from Bio::Tools::Blat by  Balamurugan Kumarasamy
#
...
=head1 SYNOPSIS
  ...
  use Bio::Tools::Pmap;
  my $blat_parser = new Bio::Tools::Pmap(-fh =>$filehandle );
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = new Bio::Tools::Pmap(-fh=>$filehandle);
 Function: Builds a new Bio::Tools::Pmap object
 Returns : Bio::Tools::Pmap
 Args    : -filename
           -fh (filehandle)
