	 ...
	 <table class="quicklinks">
	  ...
	  <tr>
	   ...
	   <td>
		  ...
		  | <a href="http://unison-db.wiki.sourceforge.net/">wiki</a>
	  ...
	  <tr>
	   ...
	   <td>
		...
		| <a href="http://sourceforge.net/project/showfiles.php?group_id=140591">download</a>
		| <a href="http://unison-db.svn.sourceforge.net/viewvc/unison-db/trunk/">svn</a>
       </td>
	  </tr>
	  ...
	  <tr>
	   <th>contact</th>
	   <td>
		  <a href="http://sourceforge.net/tracker/?atid=759616&amp;group_id=140591&amp;func=browse">issues</a>
		| <a href="http://lists.sourceforge.net/lists/listinfo/unison-db-announce">mailing list</a>
		| <a href="mailto:unison@unison-db.org?Subject=Unison">email</a>
